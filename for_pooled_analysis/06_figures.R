...
## helper: calculate AUROC from count data -------------------------------------
...
fig4_metrics = map2(
  fig4_combos$score, fig4_combos$cohort,
...
sf3_aurocs = map2(
  sf3_combos$score_name, sf3_combos$ca_01,
  function(sc, ca) {
...
sf4_pooled = map2(
  sf4_pooled_combos$score_name, sf4_pooled_combos$ca_01,
  function(sc, ca) {
